...
// ------------------------------------------------------------
// - 從會員列表帶入 initialQuery（通常 uid）
// - 查詢 orders 集合：可切欄位 userId/uid/buyerUid/customerUid
// - 點訂單可看 JSON 詳情（JsonEncoder withIndent）
// ------------------------------------------------------------
