...
exports.paymentSuccess = functions.https.onRequest(async (req, res) => {
    try {
        ...
        const { transactionId, userId, userEmail, items, // [{ productId, qty, price, name }]
        finalAmount, paymentMethod, } = payload;
        ...
        const result = await db.runTransaction(async (tx) => {
            ...
            tx.set(reportRef, {
                ...
                itemsSold: admin.firestore.FieldValue.increment(items.reduce((s, i) => s + i.qty, 0)),
            }, { merge: true });
