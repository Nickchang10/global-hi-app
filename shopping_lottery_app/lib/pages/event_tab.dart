...
class _EventTabState extends State<EventTab> {
  ...
  // ✅ 新版 withValues(alpha: ...) 需要 double?（0.0 ~ 1.0）
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            ...
            colorFilter: ColorFilter.mode(
              Colors.black.withValues(alpha: _a(0.2)),
              BlendMode.darken,
            ),
          ),
          boxShadow: [
            BoxShadow(
              color: Colors.black.withValues(alpha: _a(0.15)),
              blurRadius: 10,
  ...
  Widget _buildDailyMissionCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.black.withValues(alpha: _a(0.05)),
            blurRadius: 8,
            offset: const Offset(0, 4),
          ),
        ],
